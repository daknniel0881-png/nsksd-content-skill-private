...
def get_access_token():
    ...
    if not app_id or not app_secret:
        print("错误: 未配置 wechat.app_id 或 wechat.app_secret")
        print("  请设置环境变量 WECHAT_APP_ID / WECHAT_APP_SECRET")
        print("  或在 config.json 中配置 wechat.app_id / wechat.app_secret")
        sys.exit(1)
